...
//  UITable View Demo
//
//  Created by SubbaLakshmi on 2/26/21.
...
class MovieGridViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let gridCell = movieCollectionView.dequeueReusableCell(withReuseIdentifier: "MovieGridCollectionViewCell", for: indexPath) as! MovieGridCollectionViewCell
        ...
        gridCell.posterView.af.setImage(withURL: posterUrl!)
        return gridCell
    }
    /*
    // MARK: - Navigation
